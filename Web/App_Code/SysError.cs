...
public static class SysError
{
	...
	static void SetError()
	{
		if (dic.Count <= 0)
		{
			...
			dic.Add("LOGIN003", "参数错误，登录失败！");
			dic.Add("LOGIN004", "登录超时，请重新登录！");

			//添加
			dic.Add("ADD000", "添加成功！");
			dic.Add("ADD001", "服务器繁忙，请稍后再试！");
			dic.Add("ADD002", "参数错误，请稍后再试！");
			dic.Add("ADD003", "用户名已存在！");

			//修改
			dic.Add("EDIT000", "修改成功！");
			dic.Add("EDIT001", "服务器繁忙，请稍后再试！");
			dic.Add("EDIT002", "参数错误，请稍后再试！");

			// 删除
			dic.Add("DEL000", "删除成功！");
			dic.Add("DEL001", "服务器繁忙，请稍后再试！");
			dic.Add("DEL002", "参数错误，请稍后再试！");
			dic.Add("DEL003", "未选定任何项，删除失败！");

			//查询
			dic.Add("SELECT001", "服务器繁忙，请稍后再试！");
			dic.Add("SELECT002", "参数错误，请稍后再试！");

			//上传图片
			dic.Add("IMG000", "图片上传成功！");
			dic.Add("IMG001", "图片上传失败，请上传（格式：" + Config.g_img + "）（大小：" + Config.g_imgmax/1024 + "KB内）的图片！");
		}
	}
	/// <summary>
	/// 获取错误代码对应的错误提示
